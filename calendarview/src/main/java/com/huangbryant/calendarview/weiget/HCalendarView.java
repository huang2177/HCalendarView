...
import com.huangbryant.calendarview.R;
...
import com.huangbryant.calendarview.listener.OnSingleChooseListener;
...
public class HCalendarView extends ViewPager {
    ...
    private HCalendarPagerAdapter calendarPagerAdapter;
    ...
    public HCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void init() {
        ...
        calendarPagerAdapter = new HCalendarPagerAdapter(count);
        calendarPagerAdapter.setAttrsBean(mAttrsBean);
        calendarPagerAdapter.setOnCalendarViewAdapter(item_layout, HCalendarViewAdapter);
     ...
     * 将指定日期的农历替换成对应文字
     */
    public HCalendarView setSpecifyMap(HashMap<String, String> map) {
     ...
     * @return
     */
    public HCalendarView setInitDate(String date) {
     ...
     * @return
     */
    public HCalendarView setStartEndDate(String startDate, String endDate) {
     ...
     * @return
     */
    public HCalendarView setMultiDate(List<String> dates) {
     ...
     * @return
     */
    public HCalendarView setSingleDate(String date) {
     ...
     * @return
     */
    public HCalendarView setDisableStartEndDate(String startDate, String endDate) {
